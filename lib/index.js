...
Astronomer.prototype.initialize = function() {
  ...
  self.kinesisQueue = async.queue(self.putRecord, 1);
...
Astronomer.prototype.track = function(track) {
  ...
  self.kinesisQueue.push(params);
};

Astronomer.prototype.putRecord = function(params, callback) {
